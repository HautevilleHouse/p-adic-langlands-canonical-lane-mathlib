/-!
# Source package model for `p-adic-langlands-canonical-lane`
...
def sourceCheckoutHead : String := "d8d91c3c68850e2a2ecc895501bb0404ea3fe2f7"
...
def sourceFiles : List SourceFile := [
  ...
  { path := "scripts/pad_closure_guard.py", sha256 := "c27a8e9cf049fe13b2f1c32ec19b41742987ce884ee35d1f618ed9de8d65b36a", functionCount := 9, classCount := 0, assignmentCount := 8, parseOk := true },
...
def sourceFunctions : List SourceFunctionDecl := [
  ...
  { file := "scripts/pad_closure_guard.py", name := "_finite", args := ["v"], returns := "bool", doc := "", line := 31, isAsync := false },
  { file := "scripts/pad_closure_guard.py", name := "_resolve", args := ["path_str"], returns := "Path", doc := "", line := 35, isAsync := false },
  { file := "scripts/pad_closure_guard.py", name := "_bootstrap_registry", args := ["path"], returns := "None", doc := "", line := 42, isAsync := false },
  { file := "scripts/pad_closure_guard.py", name := "_load_registry", args := ["path"], returns := "dict[str, Any]", doc := "", line := 48, isAsync := false },
  { file := "scripts/pad_closure_guard.py", name := "_load_sigma_from_stitch", args := ["path"], returns := "float | None", doc := "", line := 60, isAsync := false },
  { file := "scripts/pad_closure_guard.py", name := "_entry", args := ["constants", "key"], returns := "tuple[float | None, bool]", doc := "", line := 77, isAsync := false },
  { file := "scripts/pad_closure_guard.py", name := "compute_report", args := ["data", "sigma_star", "strict_coh_zero"], returns := "dict[str, Any]", doc := "", line := 88, isAsync := false },
  { file := "scripts/pad_closure_guard.py", name := "append_history", args := ["path", "report"], returns := "None", doc := "", line := 121, isAsync := false },
  { file := "scripts/pad_closure_guard.py", name := "main", args := [], returns := "None", doc := "", line := 128, isAsync := false },
...
def sourceAssignments : List SourceAssignmentDecl := [
  ...
  { file := "scripts/pad_closure_guard.py", name := "SCRIPT_DIR", value := "Path(__file__).resolve().parent", line := 13 },
  { file := "scripts/pad_closure_guard.py", name := "PROJECT_ROOT", value := "SCRIPT_DIR.parent", line := 14 },
  { file := "scripts/pad_closure_guard.py", name := "DEFAULT_REGISTRY", value := "\"artifacts/constants_registry.json\"", line := 16 },
  { file := "scripts/pad_closure_guard.py", name := "DEFAULT_STITCH", value := "\"artifacts/stitch_constants.json\"", line := 17 },
  { file := "scripts/pad_closure_guard.py", name := "DEFAULT_OUT", value := "\"repro/certificate_runtime.json\"", line := 18 },
  { file := "scripts/pad_closure_guard.py", name := "DEFAULT_HISTORY", value := "\"repro/drift_guard_runs.jsonl\"", line := 19 },
  { file := "scripts/pad_closure_guard.py", name := "PRIMARY_KEYS", value := "[\"kappa_padic\", \"sigma_matching\", \"kappa_compact\", \"rho_rigidity\", \"packet_padic\"]", line := 21 },
  { file := "scripts/pad_closure_guard.py", name := "COHERENCE_KEY", value := "\"eps_coh\"", line := 28 },
...
def constantSpecs : List ConstantSpec := [
  { group := "constants", key := "kappa_padic", status := "derived_numeric", formula := "c_padic_raw * packet_density_raw - e_padic_raw", sourceSection := "paper/P_ADIC_LANGLANDS_PREPRINT.md Section 4.5 / Appendix A", validation := "required_positive", componentKeys := ["c_padic_raw", "e_padic_raw", "packet_density_raw"] },
  { group := "constants", key := "sigma_matching", status := "derived_numeric", formula := "matching_floor_raw - stabilization_loss_raw - restart_loss_raw", sourceSection := "paper/P_ADIC_LANGLANDS_PREPRINT.md Section 5.2 / Appendix B", validation := "required_positive", componentKeys := ["matching_floor_raw", "restart_loss_raw", "stabilization_loss_raw"] },
  { group := "constants", key := "kappa_compact", status := "derived_numeric", formula := "1.0 / (1.0 + delta_comp_sup_raw)", sourceSection := "paper/P_ADIC_LANGLANDS_PREPRINT.md Section 5.3 / Appendix C", validation := "required_positive", componentKeys := ["delta_comp_sup_raw"] },
  { group := "constants", key := "rho_rigidity", status := "derived_numeric", formula := "rho_rigidity_raw", sourceSection := "paper/P_ADIC_LANGLANDS_PREPRINT.md Section 6.1 / Appendix D", validation := "required_positive", componentKeys := ["rho_rigidity_raw"] },
  { group := "constants", key := "packet_padic", status := "derived_numeric", formula := "c_packet_raw * padic_gain_raw - e_packet_raw", sourceSection := "paper/P_ADIC_LANGLANDS_PREPRINT.md Section 6.2 / Appendix E.4", validation := "required_positive", componentKeys := ["c_packet_raw", "e_packet_raw", "padic_gain_raw"] },
  { group := "constants", key := "eps_coh", status := "derived_numeric", formula := "eps_coh_raw", sourceSection := "paper/P_ADIC_LANGLANDS_PREPRINT.md Appendix E.6", validation := "required_nonnegative", componentKeys := ["eps_coh_raw"] },
  { group := "stitch", key := "sigma_star_can", status := "derived_numeric", formula := "sigma_star_can_raw", sourceSection := "paper/P_ADIC_LANGLANDS_PREPRINT.md Section 5 / stitch constants", validation := "required_positive", componentKeys := ["sigma_star_can_raw"] }
]

def registryConstants : List RegistryConstant := [
  { key := "eps_coh", value := "0.0", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#eps_coh", sourceSection := "paper/P_ADIC_LANGLANDS_PREPRINT.md Appendix E.6" },
  { key := "kappa_compact", value := "0.8038585209003215", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_compact", sourceSection := "paper/P_ADIC_LANGLANDS_PREPRINT.md Section 5.3 / Appendix C" },
  { key := "kappa_padic", value := "1.0940320000000001", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_padic", sourceSection := "paper/P_ADIC_LANGLANDS_PREPRINT.md Section 4.5 / Appendix A" },
  { key := "packet_padic", value := "1.0315400000000001", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#packet_padic", sourceSection := "paper/P_ADIC_LANGLANDS_PREPRINT.md Section 6.2 / Appendix E.4" },
  { key := "rho_rigidity", value := "1.078", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#rho_rigidity", sourceSection := "paper/P_ADIC_LANGLANDS_PREPRINT.md Section 6.1 / Appendix D" },
  { key := "sigma_matching", value := "1.075", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#sigma_matching", sourceSection := "paper/P_ADIC_LANGLANDS_PREPRINT.md Section 5.2 / Appendix B" }
]
