/-!
# p-adic-langlands-canonical-lane Lean migration boundary
...
`PAdicLanglandsCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "p-adic-langlands-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/p-adic-langlands-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for p-adic Langlands: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["canonical-lane", "galois-representations", "local-to-global", "manifold-constrained", "mathematical-proof", "p-adic-hodge-theory", "representation-theory", "reproducibility", "p-adic-langlands"]
