# P Adic Langlands — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/p-adic-langlands-canonical-lane-mathlib.git
cd p-adic-langlands-canonical-lane-mathlib
lake exe
lake build
```
